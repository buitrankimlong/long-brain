...
// --- Config ---
// AI_KNOWLEDGE_VAULT = "." means repo root (works cross-platform after clone)
...
server.tool(
  ...
  async () => {
    ...
    if (analysis.length > 0) {
      ...
      output += `| File | Quality | Lines | Issues |\n|------|---------|-------|--------|\n`;
      for (const a of analysis) {
        output += `| ${a.file} | ${a.quality} | ${a.lines} | ${a.issues.join(", ")} |\n`;
      }
      output += "\n";
    }
...
server.tool(
  ...
  "Tao blueprint tai su dung tu 1 du an cu. Rut trich stack, architecture, patterns de dung lam template.",
...
server.tool(
  "vault_stats",
  "Thong ke nhanh toan bo Longbrain: so files, categories, du an, bai hoc.",
  {},
  async () => {
...
server.tool(
  "get_dashboard",
  "Doc Dashboard - trang tong quan cua Longbrain.",
  {},
  async () => {
